...
class TPInterstitial
{
  ...
  Future<bool> interstitialAdReady(String adUnitId) async{
    return await TradplusSdk.channel.invokeMethod('interstitial_ready', {
      'adUnitID': adUnitId
    });
  }
  ...
  Future<void> entryInterstitialAdScenario(String adUnitId,{String? sceneId}) async{
    Map arguments = {};
    arguments['adUnitID'] = adUnitId;
    if(sceneId != null)
    {
  ...
  setInterstitialListener(TPInterstitialAdListener listener,{String adUnitId = ""})
  {
  ...
  callback(TPInterstitialAdListener listener,String adUnitId,String method,Map arguments)
  {
    Map adInfo = {};
...
class TPInterstitialAdListener
{
  ...
  //android only 下载回调
  final Function(String adUnitId, num l,num l1,String s,String s1)? onDownloadStart;
  final Function(String adUnitId, num l,num l1,String s,String s1,int progress)? onDownloadUpdate;
  final Function(String adUnitId, num l,num l1,String s,String s1)? onDownloadPause;
  final Function(String adUnitId, num l,num l1,String s,String s1)? onDownloadFinish;
  final Function(String adUnitId, num l,num l1,String s,String s1)? onDownloadFail;
  final Function(String adUnitId, num l,num l1,String s,String s1)? onInstall;
