...
class TPInterActive
{
  ...
  Future<bool> interActiveAdReady(String adUnitId) async{
    return await TradplusSdk.channel.invokeMethod('interactive_ready', {
      'adUnitID': adUnitId
    });
  }
  ...
  setInterActiveAdListener(TPInterActiveAdListener listener,{String adUnitId = ""})
  {
  ...
  callback(TPInterActiveAdListener listener,String adUnitId,String method,Map arguments)
  {
    Map adInfo = {};
